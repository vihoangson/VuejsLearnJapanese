    ...
    <div class="_cwABShowArea actionArea">
        <ul role="toolbar" class="_messageActionNav cwTextUnselectable actionNav">
            <li
                ...
                role="button"
                data-cwui-ab-id="1203259732794540032"
                data-cwui-ab-type="reply"
            >

<template>
    <div class="navigation">
        <div class="admin">
          ...
          <span>
            <svg viewBox="0 0 10 10" id="icon_menuTask" xmlns="http://www.w3.org/2000/svg"><path
                    d="M1.563 1.146h6.875c.23 0 .417.187.417.417v5.938H7.501v1.354h-5V7.501H1.147V1.563c0-.23.187-.417.417-.417M8.752.417h-7.5a.833.833 0 0 0-.833.833v7.5c0 .46.373.833.833.833h7.5c.46 0 .833-.373.833-.833v-7.5a.833.833 0 0 0-.833-.833m-4.43 6.866L1.681 4.642l.884-.884 1.758 1.757 3.116-3.117.884.884-4 4z"></path></svg>
          </span>
                </li>
                <li class="menu-admin-item">
          <span>
            <svg viewBox="0 0 10 10" id="icon_menuFile" xmlns="http://www.w3.org/2000/svg"><path
                    d="M.417.417v2.5h9.167v-1.25H4.167L2.917.417h-2.5zM0 3.75l.417 5.833h9.167l.417-5.833h-10zm.781.73h8.438l-.313 4.375H1.093L.78 4.48z"></path></svg>
          </span>
                </li>
                <li id="openContact" class="menu-admin-item" @click="openContact">
          <span>
            <svg viewBox="0 0 10 10" id="icon_menuContact" xmlns="http://www.w3.org/2000/svg"><path
                ...
                <li class="menu-admin-item">
          <span>
            <svg viewBox="0 0 10 10" id="icon_menuInfo" xmlns="http://www.w3.org/2000/svg"><path
                    d="M4.375 8.333h1.25V3.75h-1.25v4.583zm0-5.417h1.25v-1.25h-1.25v1.25zM5 9.27A4.27 4.27 0 1 1 5 .728 4.27 4.27 0 0 1 5 9.27M5-.001A5 5 0 1 0 5.001 10 5 5 0 0 0 5 0"></path></svg>
          </span>
                </li>
            </ul>
        </div>
        <div class="my-account" v-on:focus.native="onFocus" v-on:click="isHidden = !isHidden"
          ...
          <svg viewBox="0 0 10 10" id="icon_triangleDown" xmlns="http://www.w3.org/2000/svg"><path
                  d="M2.5 3.125L5 6.875l2.5-3.75z"></path></svg>
        </span>
            </p>
        </div>

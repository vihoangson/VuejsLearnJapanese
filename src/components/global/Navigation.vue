		...
		<div class="admin">
			<ul class="menu-admin" role="navigation">
				<li class="menu-admin-item">
					<span>
						<svg viewBox="0 0 10 10" id="icon_menuTask" xmlns="http://www.w3.org/2000/svg">
							<path
				...
				<li class="menu-admin-item">
					<span>
						<svg viewBox="0 0 10 10" id="icon_menuContact" xmlns="http://www.w3.org/2000/svg">
							<path
				...
				<li class="menu-admin-item">
					<span>
						<svg viewBox="0 0 10 10" id="icon_menuInfo" xmlns="http://www.w3.org/2000/svg">
							<path
		...
		>
			...
			<p class="status-name">
				...
				<span class="menu-icon">
					<svg viewBox="0 0 10 10" id="icon_triangleDown" xmlns="http://www.w3.org/2000/svg">
